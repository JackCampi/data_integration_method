...
In general, using multiple kernels instead of a single one boosts the prediction capacity of the model. On the other hand, combining kernels in a non-linear way apparently has better results whereas when combibibg complex Gaussian kernels, linear methods are more reasonable\cite{gonen2011multiple}. 
